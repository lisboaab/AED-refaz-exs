...
def criaLista():
    ...
    file = open(".\\ficha11\\ex03\\tarefas.txt", "r", encoding="utf-8")
...
def adicionar():
    ...
    file = open(".\\ficha11\\ex03\\tarefas.txt", "a", encoding="utf-8")
    file.write(append)
    file.close()
...
def download():
    ...
    """
    fileTarefas = open(".\\ficha11\\ex03\\tarefas.txt", "w", encoding="utf-8")
