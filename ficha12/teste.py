...
def consulta():
   ...
   #  Scrollbar Vertical
    verscrlbar = ttk.Scrollbar(panel2, orient ="vertical", command = tree.yview)
    # CallinPlace da Scrollbar
    verscrlbar.place(x=442, y=10, height=250)
...
def treeview_sort_column(tv, col, reverse):
    """
    Ordenar tree através do click nos headings
    """
...
img = PhotoImage(file = ".\\ficha12\\images\\img-gestao.png")
