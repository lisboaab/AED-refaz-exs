...
def sort_columnA():
    tree.sort_column("Local", "ascend")

def sort_columnD():
    tree.sort_column("Local", "descend")
...
btnAsc = Button(window, width=35, height=35, image=imgAsc, relief=FLAT, command=sort_columnA)
btnAsc.place(x=400, y= 15)

imgdesc = PhotoImage(file = ".//testes anteriores//normal21-22//imagens//desc.png")
btndesc = Button(window, width=35, height=35, image=imgdesc, relief=FLAT, command=sort_columnD)
...
img1 = canvaImg.create_image(0,0, anchor=CENTER, image=img)
